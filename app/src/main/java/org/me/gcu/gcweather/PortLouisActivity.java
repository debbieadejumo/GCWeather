...
public class PortLouisActivity extends AppCompatActivity {
    ...
    public class ProcessInBackground extends AsyncTask<Context, Void, List<String[]>>{
        ProgressDialog progressDialog = new ProgressDialog(PortLouisActivity.this);
        ...
        protected List<String[]> doInBackground(Context... params) {
            ...
            try {
                URL url = new URL("https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/934154");
