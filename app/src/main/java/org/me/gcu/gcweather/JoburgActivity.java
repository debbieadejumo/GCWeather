...
public class JoburgActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_joburg);
    ...
    public class ProcessInBackground extends AsyncTask<Context, Void, List<String[]>>{
        ProgressDialog progressDialog = new ProgressDialog(JoburgActivity.this);
        ...
        protected List<String[]> doInBackground(Context... params) {
            ...
            try {
                URL url = new URL("https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/993800");
