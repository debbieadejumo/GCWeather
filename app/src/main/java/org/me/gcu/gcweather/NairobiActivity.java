...
public class NairobiActivity extends AppCompatActivity {
    ...
    public void onLeftArrowClick(View v){
        Intent myIntent = new Intent(getBaseContext(), LondonActivity.class);
        startActivity(myIntent);
    }

    public void onRightArrowClick(View v){
        Intent myIntent = new Intent(getBaseContext(), NewYorkActivity.class);
        startActivity(myIntent);
    }
    ...
    public class ProcessInBackground extends AsyncTask<Context, Void, List<String[]>>{
        ProgressDialog progressDialog = new ProgressDialog(NairobiActivity.this);
        ...
        protected List<String[]> doInBackground(Context... params) {
            ...
            try {
                URL url = new URL("https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/184745");
